...
# llm.predict("Hello, world!")def prompt(transcript):
...
Yeah. Thank you.""", """I. Script Follow-
  Segment 1: Introduction and Verification
    Answer: Yes
    Reason: The agent greeted the callee, verified their identity, and introduced themselves and the purpose of the call.
    Transcript: "Hello. Yeah. Am I talking to Nikhil? … Yeah Nikhil, I'm Harish here from UniScholars."

  Segment 2: Inquiry Confirmation
    Answer: Yes
    Reason: The agent confirmed the study abroad inquiry and verified the intended intake period.
    Transcript: "Yeah. So you are planning to study in Ireland, right, for your master's program?... And you're planning to go this year for the September intake or, like, for the Jan 25 intake?"

  Segment 3: Academic Background and Qualifications
    Answer: Yes
    Reason: The agent gathered relevant academic information and clarified the field of study.
    Transcript: "And what about your bachelor's, Nikhil? What have you done in your bachelor's?... completed my exams yesterday itself… 10th and Tuesday was almost about to 75 and 74."

  Segment 4: Budget and Financial Planning
    Answer: Yes
    Reason: The agent discussed the course cost, living expenses, and funding options with the callee.
    Transcript: "So Nikhil, I'll just tell you the budget as well… So in Ireland, you know, the course that you are planning… 20 lakhs. That will be including your living cost as well."

  Segment 5: Scheduling Counseling Session
    Answer: Yes
    Reason: The agent offered counseling sessions and discussed available time slots, though there was a slight mismatch with the student's availability.
    Transcript: "So, you know, he'll be guiding you about the university selection and the application process as well… today around 5 or 5:30 works for you?"

  Segment 6: Document Verification
    Answer: Yes
    Reason: The agent requested the necessary documents for verification and explained the purpose of document verification.
    Transcript: "So, Nikhil, just one last thing, you know, I'll be needing from your end is any 2 of your academical mark sheets… So I've already dropped you a message, Nikhil."

  Segment 7: Final Confirmation and Closing
    Answer: Yes
    Reason: The agent confirmed the booking of the counseling session and provided final instructions before closing the call.
    Transcript: "once you are free, you can just send me any 2 things… So then I'll just connect you with my counselor today only."
...
II. Sales Pitch
  Segment 1: Identification and Addressing by Name
    Answer: Yes
    Reason: The agent addressed the student by their name and introduced themselves and the organization.
    Transcript: "Yeah. Nikhil, I'm Harish here from UniScholars."

  Segment 2: Reference to Previous Communication
    Answer: Yes
    Reason: The agent referenced the student's previous inquiry on the website.
    Transcript: "You have placed an inquiry on our website. Right?"

  Segment 3: Confirmation of Interest
    Answer: Yes
    Reason: The agent confirmed the student's interest in studying abroad and verified the intended intake period.
    Transcript: "So you are planning to study in Ireland, right, for your master's program?... And you're planning to go this year for the September intake or, like, for the Jan 25 intake?"

  Segment 4: Addressing Concerns and Reassurances
    Answer: Partial
    Reason: The agent provided some reassurances but did not address specific concerns in detail.
    Transcript: "So, you know, he'll be guiding you about the university selection and the application process as well."

  Segment 5: Highlighting Benefits and Facilities
    Answer: Yes
    Reason: The agent highlighted the benefits and facilities of the program.
    Transcript: "So, you know, he'll be guiding you about the university selection and the application process as well. So, I just wanted to know that today …"

  Segment 6: Urgency and Scarcity
    Answer: No
    Reason: The agent did not create a sense of urgency or scarcity during the conversation.
    Transcript: Not applicable

  Segment 7: Financial Incentives and Offers
    Answer: No
    Reason: The agent did not offer specific financial incentives or special offers.
    Transcript: "the course that you are planning to pursue, it is going to cost you around 20 lakhs. That will be including your living cost as well."

  Segment 8: Explaining the Payment Process and Flexibility
    Answer: Yes
    Reason: The agent briefly mentioned funding options but could have provided more details on the payment process.
    Transcript: "So, Nikhil, the budget that I have told you, your parents, are they going to self fund this amount or they are planning to take a loan?... We are planning to be a self-funded loan."

  Segment 9: Encouragement to Commit
    Answer: Yes
    Reason: The agent encouraged the student to proceed with the counseling session booking.
    Transcript: "So then I'll just connect you with my counselor today only."

  Segment 10: Openness to Further Discussion
    Answer: Yes
    Reason: The agent was open to further discussion and answered the student's questions.
    Transcript: "Okay. I'll send you. … So I've already dropped you a message, Nikhil."

Overall Sales Pitch Score: 7/9 (Segment 6 not counted as it was not applicable)
...
1. Addressing Concerns and Reassurances - Partial:
   Reason of the point: The agent provided some reassurances but did not address specific concerns in detail.
   Improvement for the point: The agent should ask more specific questions to identify any particular concerns the student might have and address them directly.
   Transcript snippet: "So, you know, he'll be guiding you about the university selection and the application process as well."

2. Financial Incentives and Offers - No:
   Reason of the point: The agent did not offer specific financial incentives or special offers.
   Improvement for the point: The agent should mention any available scholarships or discounts on counseling services to attract the student's interest.
   Transcript snippet: "the course that you are planning to pursue, it is going to cost you around 20 lakhs. That will be including your living cost as well."

3. Explaining the Payment Process and Flexibility - Partial:
   Reason of the point: The agent mentioned the funding options but did not provide detailed information on the payment process.
   Improvement for the point: The agent should explain the payment process in more detail, including any flexible payment options or timelines.
   Transcript snippet: "So, Nikhil, the budget that I have told you, your parents, are they going to self fund this amount or they are planning to take a loan?"
...
Lead Name: Nikhil
LQT Name: Harish
Passport Status: Yes, confirmed to have a valid passport
Course: Supply Chain Management and Logistics
Country: Ireland
Intake: January 2025
Script Follow Score: 7/7
Academic Scores/CGPA: 10th: 75%, 12th: 74%, Bachelor's: 76%
Work Experience: None specified (Fresher)
Customer Budget: 20 lakhs including living expenses
Self-funding or Loan: Partial self-funding, partial loan
Counseling Scheduled Status: Counselor to call today around 5 or 5:30 PM
Competitive Exams Status: Not specified
Sales Pitch Score: 7/9
Lead Status: Qualified

Final Result: The customer is interested and a call with a counselor is scheduled at 5 or 5:30 PM today.

Actions:
  1. Send a reminder message to Nikhil about the scheduled time for the counseling session.
  2. Follow up for the documents (mark sheets and resume) once Nikhil is available.
  3. Prepare the counselor with the lead’s information to ensure a productive session.

Suggestions:
  1. Address specific concerns of the student to provide better reassurances.
  2. Mention available scholarships or discounts on counseling services to attract more interest.
  3. Provide more detailed information about the payment process and flexible payment options.

Overall Recommendations:
  1. Ensure clarity and engagement throughout the call.
  2. Provide summaries of key points to confirm understanding.
  3. Show empathy and flexibility to accommodate the student's schedule.
  4. Follow up promptly and politely to ensure document submission.
  5. Offer additional information on scholarships and extra services proactively."""),

]
def prompt(ai_prompt, transcript):
    prompt1 = f"""
    ...
    """
    return prompt1
dataset_name = "Call Transcript Dataset"
...
#     description="Conversation transcript between Agent and customer.",
# )

# for input_prompt, desired_output in example_inputs:
#     # Each example must be unique and have inputs defined.
#     # Outputs are optional
#     client.create_example(
#         inputs={"prompt": prompt(ai_prompt, input_prompt)},
#         outputs={"response": desired_output},
...
# 1. Correctness: LangSmith Question-Answer Evaluation
